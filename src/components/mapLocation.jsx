      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="md:col-span-1">
          <div className="relative h-full w-full rounded-l-lg overflow-hidden">
            ...
            <div className="absolute bottom-6 right-8 bg-black/70 text-white text-xs px-2 py-1 rounded">
              See all
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-2 py-4 px-5">
          ...
          <div className="relative w-fit">
            {/* Normal location */}
            <p className="flex items-center gap-1 transform duration-300 ease-in-out  text-gray-700 group-hover:hidden transition">
              <MdLocationOn className="text-md" />
              Amsterdam-Centrum · 0.60 km to city centre
            </p>

            {/* Hover view */}
            <p className="hidden group-hover:flex font-semibold items-center gap-1 text-blue-800 transform duration-300 ease-in-out underline cursor-pointer transition-all">
        ...
        {/* Price Section */}
        <div className="py-4">
          <div className="md:col-span-1  border-l border-dashed flex flex-col justify-between items-end text-right  pr-4">
            {/* review section */}

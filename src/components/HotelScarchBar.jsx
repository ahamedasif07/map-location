        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-3">
          ...
          <div className="md:block hidden">
            <div className="flex items-center">
              <button className="w-full lg:w-16 h-14 lg:h-[72]  bg-[#44B111] hover:bg-[#3a960e] text-white rounded-xl flex items-center justify-center transition-all shadow-md active:scale-95">
